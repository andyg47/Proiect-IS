...
public class Help_Yoga extends AppCompatActivity {
    ...
    private static final String TAG = "Help_Yoga";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.help_yoga);
    ...
    private void addItemsFromJSON() {
        try {
            ...
            for (int i=0; i<jsonArray.length(); ++i) {
                ...
                Yoga holidays = new Yoga(name, date);
